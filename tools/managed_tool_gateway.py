...
def auth_json_path():
    """Return the Alice auth store path, respecting ALICE_HOME overrides."""
    return get_alice_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`alice native`, banner/status paint, provider
