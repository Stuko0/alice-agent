# Alice Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.alice/plugins/alice-achievements/state.json` (existing unlock state)
  - `~/.alice/plugins/alice-achievements/scan_snapshot.json` (new)
  - `~/.alice/plugins/alice-achievements/scan_checkpoint.json` (new)
