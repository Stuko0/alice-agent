# Alice Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.alice/plugins/alice-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.alice/plugins/alice-achievements/scan_checkpoint.json`.
