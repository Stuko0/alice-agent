...
Configuration
-------------
Secret (lives in $ALICE_HOME/.env or the environment):
  MEM0_API_KEY       — Mem0 Platform API key (required for platform mode)

Behavioral settings (live in $ALICE_HOME/mem0.json, set via `alice memory
setup`):
  ...
  agent_id           — Agent identifier (default: alice)
...
def _load_config() -> dict:
    """Load config from env vars, with $ALICE_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "alice"),
        "oss": {},
    }
    ...
    config_path = get_alice_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "alice-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "alice"},
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $ALICE_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "alice")
