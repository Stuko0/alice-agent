...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Alice gateway adapter.

    Each inbound phone number gets its own Alice session (multi-tenant).
...
# static dict in alice_cli/gateway.py, and the _send_sms dispatch in
