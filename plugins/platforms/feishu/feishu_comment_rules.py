...
Config: ~/.alice/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.alice/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_alice_home()`` helper (ALICE_HOME-aware and
...
RULES_FILE = get_alice_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_alice_home() / "feishu_comment_pairing.json"
