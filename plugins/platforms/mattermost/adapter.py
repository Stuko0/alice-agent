...
required — uses aiohttp which is already a Alice dependency.
...
def interactive_setup() -> None:
    ...
    ``alice_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Alice delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # alice_cli/setup.py::_setup_mattermost function.
