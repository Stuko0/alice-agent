...
const SKIN_KEY = 'alice-desktop-theme-v2'
const MODE_KEY = 'alice-desktop-mode-v1'
...
const PROFILE_SKINS_KEY = 'alice-desktop-profile-themes-v1'
const PROFILE_MODES_KEY = 'alice-desktop-profile-modes-v1'
// Last active profile, recorded so the boot-time paint can pick that profile's
// theme before the gateway reports which profile actually launched.
const LAST_PROFILE_KEY = 'alice-desktop-active-profile-v1'
...
function applyTheme(theme: DesktopTheme, mode: 'light' | 'dark') {
  ...
  try {
    window.localStorage.setItem('alice-boot-background', chromeBg)
    window.localStorage.setItem('alice-boot-color-scheme', rendered)
  } catch {
...
/** Sync the desktop skin with the active Alice backend theme on connect. */
