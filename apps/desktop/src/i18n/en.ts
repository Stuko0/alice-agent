...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      ...
      backgroundExitedDuringStartup: 'Alice background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Alice Desktop.',
    ...
    native: {
      ...
      inputBody: 'Alice is waiting for your response.',
      turnDoneTitle: 'Alice finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Alice defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Alice is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Alice asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Alice was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Alice follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Alice is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Alice, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Alice checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Alice configuration...',
    ...
    gateway: {
      ...
      intro:
        'Alice Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Alice backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      remoteDesc:
        'Connect this desktop shell to a remote Alice backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /alice.',
      ...
      restartingMessage: 'Alice Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Alice ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Alice runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      customIntro: 'Endpoints you added (OpenAI-compatible or Anthropic). They appear in the model picker like built-ins.',
      customAdd: 'Add custom provider',
      customName: 'Name',
      customNamePlaceholder: 'e.g. Together AI',
      customBaseUrl: 'Base URL',
      customBaseUrlPlaceholder: 'https://api.example.com/v1',
      customKeyEnv: 'API key env var (optional)',
      customKeyEnvPlaceholder: 'e.g. TOGETHER_API_KEY',
      customApiMode: 'API dialect',
      customTest: 'Test connection',
      customSave: 'Save provider',
      customCancel: 'Cancel',
      customDelete: 'Remove',
      customDeleteConfirm: provider => `Remove custom provider "${provider}"?`,
      customProbeOk: (ms, count) => `Connected — ${ms}ms${count > 0 ? `, ${count} model(s)` : ''}`,
      ...
      helpOpen: 'Help',
      migrationTitle: 'Import from OpenClaw',
      migrationIntro: 'Bring your memories, skills and settings from an OpenClaw installation.',
      migrationScan: 'Scan for OpenClaw…',
      migrationScanning: 'Scanning…',
      migrationFound: source => `Found OpenClaw at ${source}`,
      migrationNotFound: 'No OpenClaw installation found on this machine.',
      migrationPreview: 'Preview import',
      migrationPreviewing: 'Preparing preview…',
      migrationPreviewEmpty: 'Nothing to import.',
      migrationWillImport: count => `${count} item(s) will be imported`,
      migrationConflicts: count => `${count} conflict(s) — enable "overwrite" to replace existing files`,
      migrationOverwrite: 'Overwrite conflicting files',
      migrationSecrets: 'Include API keys (allowlisted only)',
      migrationApply: 'Import now',
      migrationApplying: 'Importing…',
  ...
  starmap: {
    ...
    emptyDesc: 'As Alice builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Alice to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Alice to generate pets.',
      backgroundHint: 'You can close this — Alice will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Alice desktop' },
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@alice:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Alice environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Alice will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Alice backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Alice. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Alice...',
    placeholderReconnecting: 'Reconnecting to Alice…',
    ...
    attachUrlDesc: 'Alice will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Alice to open PR',
      agentShipPrompt:
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Alice can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Alice from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Alice will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Alice desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Alice updater takes over in its own window and reopens Alice automatically when it’s done. Please don’t reopen Alice yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Alice reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Alice reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Alice needs a one-time install',
    ...
    settingUpTitle: 'Setting up Alice Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Alice CLI or desktop instance is running. Stop any running Alice instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Alice Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Alice is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Alice…',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Alice at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Alice connects automatically',
      loopback: 'Opens your browser to sign in — Alice connects automatically',
    ...
    authorizeThere: 'Authorize Alice there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Alice there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Alice Desktop v${version}`,
      ...
      gatewayTitle: 'Alice inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Alice will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Alice is restarting...',
      askRestart: 'Ask Alice to restart the server',
      lookingRestart: taskId => `Alice is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Alice is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Alice finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Alice could not restart the server.',
      stillWorking:
        'Alice is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Alice is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Alice gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.alice/config.yaml). Alice won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Alice needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Alice needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Alice Desktop to use Save Image.',
    restartToSaveImages: 'Restart Alice Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `alice gateway` running?'
    }
  },
