...
/** Why a known Alice command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Alice profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Alice Agent version', surface: exec() },
 ...
 * Alice' built-in slash commands — i.e. skill commands (`/gif-search`,
