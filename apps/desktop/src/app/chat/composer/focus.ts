...
const FOCUS_EVENT = 'alice:composer-focus'
const INSERT_EVENT = 'alice:composer-insert'
const INSERT_REFS_EVENT = 'alice:composer-insert-refs'
const SUBMIT_EVENT = 'alice:composer-submit'
const VOICE_TOGGLE_EVENT = 'alice:composer-voice-toggle'
