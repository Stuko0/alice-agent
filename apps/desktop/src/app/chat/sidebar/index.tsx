...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/alice'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('alice:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('alice:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Alice to
