...
import type { RpcEvent } from '@/types/alice'
...
export function useGatewayBoot({
  ...
  useEffect(() => {
    ...
    // composer stayed disabled forever on "Starting Alice...". Once the
    ...
    const attemptReconnect = async () => {
      ...
      try {
        ...
        // "Starting Alice…". The probe is a no-op for a healthy or local backend.
        ...
        // as an opaque "Could not connect to Alice gateway". resolveGatewayWsUrl
