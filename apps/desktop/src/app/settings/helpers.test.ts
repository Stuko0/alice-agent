...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: AliceConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: AliceConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // ALICE_QWEN_ shares the ALICE_ stem with other integrations.
      expect(providerGroup('ALICE_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
