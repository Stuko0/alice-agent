import type { AliceConfigRecord, ToolsetInfo } from '@/types/alice'
...
export function getNested(obj: AliceConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: AliceConfigRecord, path: string, value: unknown): AliceConfigRecord {
...
function personalityOptions(config: AliceConfigRecord): string[] {
