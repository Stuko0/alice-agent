...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/alice'
 ...
 * log inline — the GUI equivalent of the install step `alice native` runs
