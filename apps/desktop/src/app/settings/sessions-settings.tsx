...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/alice'
...
// / Program Files), which buried any files Alice wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.aliceDesktop` is
    ...
    const settings = window.aliceDesktop?.settings
