...
export function buildReviewFlatList(files: AliceReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: AliceReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
