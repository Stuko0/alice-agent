...
export interface PetInfo {
  ...
  // the Alice "run" activity state uses the in-place running row).
 ...
 * ALICE_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'alice.desktop.pet-roam.v1'
