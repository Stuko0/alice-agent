 ...
 * app's bounds and stays visible while Alice is minimized. That window carries
...
const OVERLAY_ACTIVE_KEY = 'alice.desktop.pet-overlay-active.v1'
const OVERLAY_BOUNDS_KEY = 'alice.desktop.pet-overlay-bounds.v1'
