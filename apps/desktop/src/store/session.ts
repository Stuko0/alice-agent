...
const WORKSPACE_CWD_KEY = 'alice.desktop.workspace-cwd'
...
const COMPOSER_MODEL_KEY = 'alice.desktop.composer.model'
const COMPOSER_PROVIDER_KEY = 'alice.desktop.composer.provider'
const COMPOSER_EFFORT_KEY = 'alice.desktop.composer.reasoning-effort'
const COMPOSER_FAST_KEY = 'alice.desktop.composer.fast'
...
const LAST_SESSION_KEY = 'alice.desktop.lastSessionId'
