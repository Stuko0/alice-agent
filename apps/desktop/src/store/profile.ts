...
import { getProfiles, setApiRequestProfile } from '@/alice'
...
import type { ProfileInfo } from '@/types/alice'
...
// /api/profiles/active `current`). "default" is the root ~/.alice. This is the
...
const PROFILE_ORDER_STORAGE_KEY = 'alice.desktop.profileOrder'
...
const PROFILE_COLORS_STORAGE_KEY = 'alice.desktop.profileColors'
...
const SHOW_ALL_PROFILES_STORAGE_KEY = 'alice.desktop.showAllProfiles'
...
// Switch to the default (root ~/.alice) profile — bound to ⌘1.
