...
cd apps/desktop
XCURSOR_SIZE=24 ALICE_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/alice-typing
# → /tmp/alice-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/alice-typing.before.heapsnapshot
# → /tmp/alice-typing.after.heapsnapshot
```
