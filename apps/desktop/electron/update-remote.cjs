 ...
 *
 * A public install can end up with `origin=git@github.com:Stuko0/alice-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Stuko0/alice-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/stuko0/alice-agent'
