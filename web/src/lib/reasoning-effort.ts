 ...
 *
 * Values mirror alice_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Alice default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Alice' default when unset). */
