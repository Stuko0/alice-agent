 ...
 *
 * Plugins call window.__ALICE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__ALICE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__ALICE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__ALICE_PLUGIN_SDK__ = {
    ...
    // window.__ALICE_SESSION_TOKEN__ directly.
    authedFetch,
