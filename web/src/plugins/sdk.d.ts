/**
 * Alice Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__ALICE_PLUGIN_SDK__`` and
 * ``window.__ALICE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__ALICE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``AlicePluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@alice/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__ALICE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__ALICE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__ALICE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface AlicePluginSDK {
...
declare global {
  interface Window {
    __ALICE_PLUGIN_SDK__?: AlicePluginSDK;
    __ALICE_PLUGINS__?: PluginRegistry;
  }
}
