...
const STORAGE_KEY = "alice-dashboard-theme";
...
const FONT_STORAGE_KEY = "alice-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `alice_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "alice-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-alice-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-alice-theme-font", "true");
