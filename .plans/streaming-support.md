# Streaming LLM Response Support for Alice Agent
...
```
ALICE_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("ALICE_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `alice_cli/config.py` | 1 | +streaming config defaults |
