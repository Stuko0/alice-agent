...
def _profile_user_agent() -> str:
    """Return a ``alice-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from alice_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"alice-cli/{_ver}"
    except Exception:
        return "alice-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # alice-cli UA so the catalog endpoint is reachable.
