...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$ALICE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_alice_dir("platforms/whatsapp/session", "whatsapp/session")
