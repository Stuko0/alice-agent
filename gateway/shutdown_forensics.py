...
def check_systemd_timing_alignment(drain_timeout: float) -> Optional[Dict[str, Any]]:
    ...
    upgraded alice-agent but never re-ran ``alice setup`` to regenerate
    ...
    try:
        # /proc/self/cgroup gives us "0::/user.slice/.../alice-gateway.service"
    ...
    # that's the common case for alice.
    ...
    # constant in alice_cli/gateway.py.
    headroom = 30.0
