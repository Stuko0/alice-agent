#!/usr/bin/env python3
"""Build the Alice Skills Index — a centralized JSON catalog of all skills.
...
`alice skills search/install` can use it without hitting the GitHub API.
...
# Ensure ALICE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Alice Skills Index...", flush=True)
