...
stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    mkdir -p $out/share/alice-desktop $out/bin
    cp -r ${renderer}/* $out/share/alice-desktop/
    ...
    substituteInPlace $out/share/alice-desktop/electron/main.cjs \
    ...
    substituteInPlace $out/share/alice-desktop/electron/git-review-ops.cjs \
      --replace-fail "process.resourcesPath" "'$out/share/alice-desktop'"
