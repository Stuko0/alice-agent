...
- The wrapper exports `ALICE_BUNDLED_SKILLS`, `ALICE_OPTIONAL_SKILLS`, and `ALICE_MANAGED=homebrew` so packaged installs keep runtime assets and defer upgrades to Homebrew.
