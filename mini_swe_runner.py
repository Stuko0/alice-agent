#!/usr/bin/env python3
"""
SWE Runner with Alice Trajectory Format

A runner that uses Alice-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Alice-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Alice-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Alice format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Alice-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Alice-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Alice Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Alice-Agent's built-in execution environments
    and outputs trajectories in Alice-Agent format.
    """
    ...
    def _convert_to_lydia_format(
        ...
        """
        Convert internal message format to Alice trajectory format.
...
def main(
    ...
    """
    Run SWE tasks with Alice trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Alice Trajectory Format")
    print("=" * 60)
