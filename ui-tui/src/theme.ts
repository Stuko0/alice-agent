...
// Mirrors @alice/ink's colorize.ts. Keep local: app code compiles from
// ui-tui/src, while @alice/ink is bundled separately from packages/.
...
//
// Anything we can't decide stays dark — the default Alice palette
// is the dark one.
