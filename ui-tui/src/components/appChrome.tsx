import { Box, type ScrollBoxHandle, stringWidth, Text } from '@alice/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (ALICE_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (ALICE_DEV_CREDITS), lowest priority,
