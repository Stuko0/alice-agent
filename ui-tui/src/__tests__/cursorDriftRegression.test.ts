 ...
 *
 * Symptom: in `alice --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@alice/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using alice --tui and as i type multiline my caret at the end will often ' +
