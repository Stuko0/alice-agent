...
import type { ScrollBoxHandle } from '@alice/ink'
import { evictInkCaches } from '@alice/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.ALICE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
