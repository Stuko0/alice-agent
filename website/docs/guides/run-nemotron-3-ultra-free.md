---
sidebar_position: 0
title: "Run Nemotron 3 Ultra free in Alice Agent"
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Alice Agent"
---

# Run Nemotron 3 Ultra free in Alice Agent

Stuko has been inducted into the **Nemotron Coalition** of leading AI labs working with **NVIDIA** to advance open frontier foundation models. In honor of this, we've partnered with **Nebius** to provide **Nemotron 3 Ultra** free on [Nous Portal](https://stuko.dev) for two weeks (**June 4th – June 18th**). Follow the instructions below to try the model in your Alice Agent today.
...
[Download the Alice Desktop installer](https://alice-agent.stuko.dev/) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://stuko.dev) account (or sign in), choose the **Free** plan, and authorize Alice. The app connects automatically.
...
Prefer to review first? Download [`install.sh`](https://alice-agent.stuko.dev/install.sh), inspect it, then run it.
...
Select **Quick Setup**. Alice opens a browser tab and waits for you to finish the next steps.

### 3. Create a Nous Portal account

In the browser, create a [Nous Portal](https://stuko.dev) account (or sign in) and choose the **Free** plan.

### 4. Connect your account

When prompted to connect your account to Alice Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `alice portal info` confirms you're logged in and routing through Nous.
...
- **[Run Alice Agent with Nous Portal](/guides/run-alice-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
