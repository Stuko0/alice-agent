...
Message-template support (the workaround for outside-window sends) is not yet implemented in Alice. If you need it, please [open an issue](https://github.com/Stuko0/alice-agent/issues) — it's planned but waiting on a clear demand signal.
