...
```bash
python3 -m pyfiglet "ALICE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=ALICE&font=Slant" | boxes -d stone
```
