...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Alice Agent |
| License | MIT |
...
```
SCRIPT=~/.alice/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.alice/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
