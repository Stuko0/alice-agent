...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Alice Agent |
| License | MIT |
...
Helper script path: `~/.alice/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.alice/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.alice/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.alice/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
