...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Alice Agent |
| License | MIT |
...
The script reads `${ALICE_HOME:-~/.alice}/.env` for two optional defaults:
...
Helper script: `~/.alice/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.alice/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${ALICE_HOME:-~/.alice}/.env`.
...
```bash
python3 ~/.alice/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.alice/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
