...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/health/neuroskill-bci` |
...
Connect Alice to a running [NeuroSkill](https://neuroskill.com/) instance to read
