...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Alice Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $ALICE_OSINT_CACHE/icij/ (default: ~/.cache/alice-osint/icij/).
...
# Set ALICE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
