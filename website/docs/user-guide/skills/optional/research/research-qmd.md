...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/research/qmd` |
...
Alice Agent via the native MCP client. This is the preferred
...
Then configure Alice Agent to connect via HTTP:
