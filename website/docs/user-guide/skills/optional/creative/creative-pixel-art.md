...
| | |
|---|---|
| Source | Optional — install with `alice skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.alice/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.alice/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Alice installs package this)
