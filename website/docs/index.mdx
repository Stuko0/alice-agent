...
slug: /
sidebar_position: 0
title: "Alice Agent Documentation"
...
>
  ...
  <a
    href="https://github.com/Stuko/alice-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
After installing, run `alice setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Alice safely  |
| 🧭 **[Use MCP with Alice](/guides/use-mcp-with-alice)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Alice](/guides/use-voice-mode-with-alice)** | Hands-on setup and usage patterns for Alice voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Alice' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Alice                              |
...
- **Built by model trainers** — Created by [Stuko](https://stuko.dev), the lab behind Alice, Nomos, and Psyche. Works with [Nous Portal](https://stuko.dev), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Stuko](https://stuko.dev) — the lab behind Alice, Nomos, and Psyche models
