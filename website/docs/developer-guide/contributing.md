...
- **Profile-safe paths**: Never hardcode `~/.alice` — use `get_alice_home()` from `alice_constants` for code paths and `display_alice_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/alice-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/NousResearch/alice-agent/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/alice-agent/blob/main/LICENSE).
