...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Alice Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Alice Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
- Building a custom/local tool without modifying Alice core? Start with [Build a Alice Plugin](../guides/build-a-alice-plugin.md)
- Building a new built-in core tool for Alice itself? Start with [Adding Tools](./adding-tools.md)
...
- **Profile-safe paths**: Never hardcode `~/.alice` — use `get_alice_home()` from `alice_constants` for code paths and `display_alice_home()` for user-facing messages. See [AGENTS.md](https://github.com/Stuko0/alice-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
- Use [GitHub Issues](https://github.com/Stuko0/alice-agent/issues)
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/Stuko0/alice-agent/blob/main/LICENSE).
