...
Both publish at:
  https://alice-agent.nousresearch.com/docs/llms.txt
  https://alice-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://alice-agent.nousresearch.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/alice-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://alice-agent.nousresearch.com/docs\n",
        "Short index: https://alice-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
