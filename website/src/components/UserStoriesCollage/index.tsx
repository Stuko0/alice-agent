  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Alice Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Alice &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Alice?{' '}
        <a
          href="https://github.com/Stuko0/alice-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://stuko.dev" target="_blank" rel="noopener noreferrer">
          Stuko Discord
        </a>{' '}
