...
Data file: $ALICE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_ALICE_HOME = Path(os.environ.get("ALICE_HOME", Path.home() / ".alice"))
DATA_DIR = _ALICE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
