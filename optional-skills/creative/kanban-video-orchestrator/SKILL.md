...
metadata:
  alice:
    ...
    credits: |
      ...
      https://github.com/Stuko0/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `alice kanban create` call to a specialist profile. The kanban
