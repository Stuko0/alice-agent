...
$LYDIA_OSINT_CACHE/icij/ (default: ~/.cache/alice-osint/icij/) and search
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $LYDIA_OSINT_CACHE/icij or ~/.cache/alice-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
