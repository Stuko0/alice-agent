...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host ALICE_REDACT_SECRETS."""
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        mock_result = {"success": True, "data": {"title": "ok", "url": "https://10.1.200.116:3000/arquant-admin/NewAlice"}}
        with patch("tools.browser_tool._run_browser_command", return_value=mock_result), \
            ...
            result = browser_navigate("https://10.1.200.116:3000/arquant-admin/NewAlice")
        parsed = json.loads(result)
