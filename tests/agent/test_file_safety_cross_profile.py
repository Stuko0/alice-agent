"""Tests for the cross-Alice-profile write guard in agent/file_safety.

The guard fires when a tool tries to write into another Alice profile's
...
Reference: May 2026 incident — a alice-security profile session
accidentally edited skills under both ~/.alice/profiles/alice-security/skills/
AND ~/.alice/skills/ (the default profile's skills), realizing only
...
# ---------------------------------------------------------------------------
# Helpers — set up a fake Alice root with two profiles, monkeypatch the
