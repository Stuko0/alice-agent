...
thinking phase.  Alice's default cloud-stream stale detector
(``ALICE_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``ALICE_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
