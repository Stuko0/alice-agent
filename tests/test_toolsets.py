...
class TestToolsetConsistency:
    ...
    def test_alice_platforms_share_core_tools(self):
        ...
        on alice-discord, gated on DISCORD_BOT_TOKEN) are allowed on top —
        the invariant is that the core set is identical across platforms.
        """
        platforms = ["alice-cli", "alice-telegram", "alice-discord", "alice-whatsapp", "alice-slack", "alice-signal", "alice-homeassistant"]
