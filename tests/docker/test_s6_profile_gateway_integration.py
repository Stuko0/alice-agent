...
The unit tests in tests/alice_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned alice-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/alice")
from alice_cli.service_manager import S6ServiceManager
