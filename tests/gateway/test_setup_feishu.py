"""Tests for _setup_feishu() in alice_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("alice_cli.config.save_env_value", side_effect=mock_save), \
         patch("alice_cli.config.get_env_value", side_effect=mock_get), \
         patch("alice_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("alice_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("alice_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("alice_cli.cli_output.print_header"), \
         patch("alice_cli.cli_output.print_info"), \
         patch("alice_cli.cli_output.print_success"), \
         patch("alice_cli.cli_output.print_warning"), \
         patch("alice_cli.cli_output.print_error"), \
