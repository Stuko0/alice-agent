...
closure the PR changed, against a real temp ``ALICE_HOME``.
"""
...
def _setup_isolated_home(tmp_path, monkeypatch, model_yaml_value):
    ...
    monkeypatch.setattr(
        "alice_cli.model_switch.resolve_display_context_length",
        lambda *a, **k: 272000,
    )
