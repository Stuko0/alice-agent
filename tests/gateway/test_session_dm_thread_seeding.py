...
def store(tmp_path, monkeypatch):
    ...
    ~/.alice/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at alice_state import time, before pytest's ALICE_HOME monkeypatch
    fires — the autouse fixture's ALICE_HOME override doesn't help here.)
    """
    import alice_state
