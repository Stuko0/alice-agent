...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "alice_approve_once" in action_ids
        assert "alice_approve_session" in action_ids
        assert "alice_approve_always" in action_ids
        assert "alice_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "alice_deny", "value": "session-key"}
