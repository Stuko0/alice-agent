...
The main() function in alice_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `alice -c model`
...
def _build_parser():
    """Build a minimal replica of the alice top-level parser."""
