"""Tests for alice_cli/completion.py — shell completion script generation."""
...
from alice_cli.completion import _walk, generate_bash, generate_zsh, generate_fish
...
def _make_parser() -> argparse.ArgumentParser:
    """Build a minimal parser that mirrors the real alice structure."""
    p = argparse.ArgumentParser(prog="alice")
...
class TestGenerateFish:
    def test_disables_file_completion(self):
        ...
        assert "complete -c alice -f" in out
