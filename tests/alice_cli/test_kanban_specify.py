"""Tests for the specifier module + `alice kanban specify` CLI surface.
...
from alice_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `alice kanban …` argparse surface directly."""
