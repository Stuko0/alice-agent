"""Tests for the interactive session browser (`alice sessions browse`).
...
from alice_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """alice sessions browse should be parseable."""
