...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Alice's web-provider config and
        ...
        # native search engine for xAI sessions instead of Alice's
        # configured web provider (Tavily/etc.), and those results bypass
        # Alice's tool-trace / citation plumbing (they arrive baked into the
