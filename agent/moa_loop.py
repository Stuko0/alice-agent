...
MoA-enabled; the normal Alice Agent loop still owns tool calling and turn
...
def _reference_messages(messages: list[dict[str, Any]]) -> list[dict[str, Any]]:
    ...
    conversation flow, but flatten it into clean user/assistant *text* turns:
      ...
      - system prompt: dropped (8K of Alice boilerplate, not advisory signal).
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Alice Agent. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Alice Agent loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
