...
Built for [Alice Agent](https://github.com/Stuko/alice-agent). Usable in any coding agent. Canonical source lives here; synced to [`Stuko/alice-agent/skills/creative/ascii-video`](https://github.com/Stuko/alice-agent/tree/main/skills/creative/ascii-video) via PR.
