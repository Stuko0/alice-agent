"""
Single source of truth for provider identity in Alice Agent.
...
2. **Alice overlays** — transport type, auth patterns, aggregator flags,
...
# -- Alice overlay ----------------------------------------------------------
# Alice-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class AliceOverlay:
    """Alice-specific provider metadata layered on top of models.dev."""
...
ALICE_OVERLAYS: Dict[str, AliceOverlay] = {
    "moa": AliceOverlay(
        transport="openai_chat",
        auth_type="virtual",
        base_url_override="moa://local",
    ),
    "openrouter": AliceOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "openai-codex": AliceOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://chatgpt.com/backend-api/codex",
    ),
    "openai-api": AliceOverlay(
        transport="codex_responses",
        base_url_override="https://api.openai.com/v1",
        base_url_env_var="OPENAI_BASE_URL",
    ),
    "xai-oauth": AliceOverlay(
        transport="codex_responses",
        auth_type="oauth_external",
        base_url_override="https://api.x.ai/v1",
        base_url_env_var="XAI_BASE_URL",
    ),
    "qwen-oauth": AliceOverlay(
        transport="openai_chat",
        auth_type="oauth_external",
        base_url_override="https://portal.qwen.ai/v1",
        base_url_env_var="ALICE_QWEN_BASE_URL",
    ),
    "lmstudio": AliceOverlay(
        transport="openai_chat",
        auth_type="api_key",
    ...
    "copilot-acp": AliceOverlay(
        transport="codex_responses",
        auth_type="external_process",
        base_url_override="acp://copilot",
        base_url_env_var="COPILOT_ACP_BASE_URL",
    ),
    "github-copilot": AliceOverlay(
        transport="openai_chat",
        extra_env_vars=("COPILOT_GITHUB_TOKEN", "GH_TOKEN"),
    ),
    "anthropic": AliceOverlay(
    ...
    "kimi-for-coding": AliceOverlay(
        transport="openai_chat",
        base_url_env_var="KIMI_BASE_URL",
    ),
    "stepfun": AliceOverlay(
        transport="openai_chat",
        extra_env_vars=("STEPFUN_API_KEY",),
        base_url_override="https://api.stepfun.ai/step_plan/v1",
        base_url_env_var="STEPFUN_BASE_URL",
    ),
    "minimax": AliceOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_BASE_URL",
    ),
    "minimax-oauth": AliceOverlay(
        transport="anthropic_messages",
        auth_type="oauth_external",
        base_url_override="https://api.minimax.io/anthropic",
    ),
    "minimax-cn": AliceOverlay(
        transport="anthropic_messages",
        base_url_env_var="MINIMAX_CN_BASE_URL",
    ),
    "deepseek": AliceOverlay(
        transport="openai_chat",
        base_url_env_var="DEEPSEEK_BASE_URL",
    ),
    "alibaba": AliceOverlay(
        transport="openai_chat",
        base_url_env_var="DASHSCOPE_BASE_URL",
    ),
    "alibaba-coding-plan": AliceOverlay(
        transport="openai_chat",
        base_url_env_var="ALIBABA_CODING_PLAN_BASE_URL",
    ),
    "opencode": AliceOverlay(
        transport="openai_chat",
        is_aggregator=True,
        base_url_env_var="OPENCODE_ZEN_BASE_URL",
    ),
    "opencode-go": AliceOverlay(
        transport="openai_chat",
        is_aggregator=True,
    ...
    "azure-foundry": AliceOverlay(
        transport="openai_chat",  # default; overridden by api_mode in config
        base_url_env_var="AZURE_FOUNDRY_BASE_URL",
    ),
    "bedrock": AliceOverlay(
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "alice", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. Alice overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + Alice overlay
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + alice extra
    ...
    if overlay is not None:
        # Alice-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
