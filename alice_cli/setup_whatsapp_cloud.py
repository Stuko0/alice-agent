...
Entry point: ``alice whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``alice_cli/main.py``).
...
Alice gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Alice to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Alice needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Alice gateway in another terminal:")
    print("         alice gateway")
    print()
    ...
    print()
    print("  Docs: https://alice-agent.nousresearch.com/docs/user-guide/")
