"""
Alice CLI - Unified command-line interface for Alice Agent.

Provides subcommands for:
- alice chat          - Interactive chat (same as ./alice)
- alice gateway       - Run gateway in foreground
- alice gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `alice setup` on a fresh Pi.
    ...
    alice_cli/stdio.py::configure_windows_stdio() runs later from the entry
