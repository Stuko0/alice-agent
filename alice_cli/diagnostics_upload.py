"""Client for uploading ``alice debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``alice debug share``.
...
NAS_BASE = os.environ.get(
    "ALICE_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "alice-agent/debug-share"
