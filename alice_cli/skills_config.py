"""
Skills configuration for Alice Agent.
`alice skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.alice/config.yaml under:
...
from alice_cli.config import cfg_get, load_config, save_config
from alice_cli.colors import Colors, color
from alice_cli.platforms import PLATFORMS as _PLATFORMS
