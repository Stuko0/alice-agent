"""``alice native`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'alice native' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # alice native list [--platform cli]
    ...
    # alice native disable <name...> [--platform cli]
    ...
    # alice native enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `alice native` runs after you pick a provider that\n"
